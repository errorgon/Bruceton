...
config.set({
  "singleRun": true,
  "autoWatch": false,
  "basePath": "D:\\JavaProjects\\Bruceton\\build\\js\\packages\\Bruceton-test\\node_modules",
  "files": [
    "D:\\JavaProjects\\Bruceton\\build\\js\\packages\\Bruceton-test\\adapter-browser.js"
  ],
  "frameworks": [
    "mocha"
  ],
...
;(function(config) {
    ...
    const handler = (percentage, message, ...args) => {
        ...
        msg = msg.replace(new RegExp("D:\\JavaProjects\\Bruceton\\build\\js", 'g'), '');;
        console.log(msg);
    };
